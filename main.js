...
// --- Localization (Rich Content + AI Reports) ---
let i18n = {
  ko: { 
    ...
    pages: {
      about: { 
        ...
        content: `
          ...
          <h3 style="margin:1.5rem 0 0.5rem; border-left:4px solid var(--primary); padding-left:0.8rem;">우리의 기술력</h3>
          <ul style="margin-bottom:1rem; padding-left:1.2rem; list-style:disc; line-height:1.8;">
            ...
            <li><strong>문맥 기반 AI 번역:</strong> 단순 번역을 넘어 해당 키워드가 왜 이슈인지 맥락을 파악하여 번역합니다.</li>
            <li><strong>랭킹 변화 트래킹:</strong> 트렌드의 생성부터 소멸까지 전 주기를 정밀 추적합니다.</li>
          </ul>
          <p>TrendUp을 통해 대화의 주제를 선점하고 비즈니스의 미래를 먼저 예측하세요.</p>
        ` 
      },
      privacy: { 
        ...
        content: `
          ...
          <p style="margin-bottom:1rem;">TrendUp(이하 '서비스')은 이용자의 개인정보를 소중히 다루며, 관련 법령을 철저히 준수합니다. (v2.1.1)</p>
          <h3>1. 수집 항목 및 방법</h3>
          <p>회원가입 없이 이용 가능하며, 서비스 품질 개선을 위해 접속 IP, 브라우저 정보, 쿠키 등이 자동 수집될 수 있습니다.</p>
          <h3>2. 구글 애드센스 (Google AdSense)</h3>
          <p>본 사이트는 구글 애드센스를 통해 광고를 게재합니다. 구글을 포함한 제3자 제공업체는 쿠키를 사용하여 사용자의 이전 방문 기록을 바탕으로 맞춤형 광고를 제공합니다. 이용자는 <a href="https://www.google.com/settings/ads" target="_blank" style="color:var(--primary);">구글 광고 설정</a>에서 이를 해제할 수 있습니다.</p>
          <h3>3. 데이터 보호</h3>
          <p>수집된 익명 데이터는 통계 분석 목적으로만 사용되며, 법적 의무가 없는 한 제3자에게 제공되지 않습니다.</p>
        ` 
      },
      terms: { 
        ...
        content: `
          ...
          <h3>제1조 (목적)</h3>
          <p>본 약관은 TrendUp 서비스의 이용 조건 및 절차를 규정함을 목적으로 합니다.</p>
          <h3>제2조 (정보 제공 및 면책)</h3>
          <p>TrendUp이 제공하는 모든 데이터는 주요 포털의 공개 데이터를 알고리즘이 처리한 참고용 자료입니다. 정보의 완전성이나 정확성을 보장하지 않으며, 데이터 활용에 따른 모든 결과의 책임은 이용자에게 있습니다.</p>
          <h3>제3조 (저작권)</h3>
          <p>서비스의 디자인 및 AI 요약 텍스트의 저작권은 TrendUp에 귀속됩니다.</p>
        ` 
      },
      contact: { 
        title: "문의 및 고객 지원 (Contact)", 
        content: `<h2 style="margin-bottom:1.5rem;">고객 지원 센터</h2><p>서비스 제안, 오류 제보, 제휴 문의는 아래 메일로 연락 주시기 바랍니다.</p><div style="margin-top:2rem; padding:1.5rem; background:var(--surface); border-radius:16px; border:1px solid var(--border);"><p><strong>Email:</strong> help@trendup.ai</p><p style="margin-top:0.5rem;"><strong>운영 시간:</strong> 평일 09:00 - 18:00 (KST)</p></div>` 
      }
    }
  },
  ja: { 
    ...
    pages: {
      about: { 
        title: "TrendUpについて: グロー바ルトレンド・インテリジェンス", 
        content: `<h2>世界の流れ를 瞬時に把握、TrendUp</h2><p style="line-height:1.8;">TrendUpは、ビッグデータ処理技術と最新のAI翻訳エンジンを組み合わせ、主要国の検索トレンドをリアルタイムで分析・可視化するデータプラットフォームです。</p><h3 style="margin-top:1.5rem;">コア技術</h3><p>Google、Yahoo Japan、Naverなどの主要ポータルの公開データを10分ごとに正規化し、世界の潮流を理解できるようサポートします。</p>` 
      },
      privacy: { 
        title: "個人情報保護方針 (Privacy Policy)", 
        content: `<h2 style="margin-bottom:1.5rem;">個人情報保護方針</h2><p>TrendUp（以下「当サービス」）は、ユーザーの個人情報を尊重し、関連法規を遵守します。(v2.1.1)</p><h3>Google AdSenseについて</h3><p>当サイトはGoogle AdSenseを使用しています。Googleなどの第三者配信事業者は、Cookieを使用してユーザーの過去のアクセス情報に基づいて広告を配信します。</p>` 
      },
      terms: { title: "利用規約 (Terms of Service)", content: `<h2>利用規約</h2><p>提供される全てのデータは参考用であり、完全性や正確性を保証するものではありません。</p>` },
      contact: { title: "お問い合わせ (Contact)", content: `<h2>サポートセンター</h2><p>Email: help@trendup.ai</p>` }
    }
  },
  en: { 
    ...
    menu: { about: "About TrendUp", privacy: "Privacy Policy", terms: "Terms of Service", contact: "Contact Us", siteInfo: "Site Information" },
    pages: {
      about: { 
        title: "About TrendUp: Global Trend Intelligence", 
        content: `<h2>Global Trends at a Glance, TrendUp</h2><p style="line-height:1.8;">TrendUp is a next-generation data intelligence platform that leverages advanced AI translation and data processing technologies to track real-time search trends.</p><h3 style="margin-top:1.5rem;">Our Methodology</h3><p>We normalize public search data from global indicators every 10 minutes, providing contextual summaries to bridge the information gap across borders.</p>` 
      },
      privacy: { 
        title: "Privacy Policy", 
        content: `<h2>Privacy Policy</h2><p>TrendUp respects your privacy and is committed to protecting it. (v2.1.1)</p><h3>Google AdSense</h3><p>We use Google AdSense to serve ads. Third-party vendors use cookies to serve ads based on prior visits. You may opt out in Google Ads Settings.</p>` 
      },
      terms: { title: "Terms of Service", content: `<h2>Terms of Service</h2><p>All data provided by TrendUp are for informational purposes only. We do not guarantee absolute accuracy.</p>` },
...
class App {
  ...
  refreshUIText() {
    try {
      ...
      if (footerText) footerText.textContent = `© 2026 TrendUp. All rights reserved. (v2.1.1)`;
      
      const menuTitles = document.querySelectorAll('.menu-section .menu-title');
      if (menuTitles[0]) menuTitles[0].textContent = t.T;
      ...
      document.querySelectorAll('[data-page]').forEach(link => {
        ...
        if (t.menu[key]) link.textContent = t.menu[key];
      });
    } catch (e) {}
  }
  initThemeIcons() {
