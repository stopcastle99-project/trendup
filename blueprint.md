...
- [x] Localize cookie banner text and button for Korean, Japanese, and English (v2.4.13).
- [x] Update version to v2.4.13 and synchronize all root assets with the public/ directory.
