...
- [x] Localize cookie banner text and button for Korean, Japanese, and English (v2.4.9).
- [x] Update version to v2.4.9 and synchronize all root assets with the public/ directory.
