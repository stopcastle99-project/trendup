...
- [x] Localize cookie banner text and button for Korean, Japanese, and English (v2.4.14).
- [x] Update version to v2.4.14 and synchronize all root assets with the public/ directory.
