...
const ICONS = {
  ...
  system: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12.2.30"></path><path d="M12 7V17"></path><path d="M12 12h5"></path><path d="M12.2.30 10 0 0 0 0 20z" fill="currentColor" fill-opacity="0.3"></path></svg>`
};
...
let i18n = {
      ...
      about: { 
        ...
        content: `
          ...
          <ul style="margin-bottom:1rem; padding-left:1.2rem; list-style:disc; line-height:1.8;">
            ...
            <li><strong>문맥 기반 AI 번역:</strong> 키워드의 맥락을 파악하여 사용자의 언어로 최적화하여 제공합니다.</li>
            <li><strong>랭킹 변화 트래킹:</strong> 트렌드의 생애 주기를 정밀 추적합니다.</li>
          </ul>
        ` 
      },
      privacy: { 
        ...
        content: `
          ...
          <p style="margin-bottom:1rem;">TrendUp(이하 '서비스')은 이용자의 개인정보를 소중히 다루며 관련 법령을 준수합니다. (v2.2.3)</p>
          <h3>1. 수집 항목 및 방법</h3>
  ...
  ja: { title: "リアルタイムトレンド", update: "最終更新", summary: "AI分析レポート", news: "関連ニュース", videos: "YouTubeニュース", loading: "読み込み中...", original: "原文", menu: { about: "TrendUpについて", privacy: "個人情報保護方針", terms: "利用規約", contact: "お問い合わせ", siteInfo: "サイト案内" }, pages: { about: { title: "TrendUp", content: `<p>グローバルトレンドプラットフォーム</p>` }, privacy: { title: "Privacy", content: `<p>v2.2.3</p>` }, terms: { title: "Terms", content: `<p>利用規約</p>` }, contact: { title: "Contact", content: `<p>help@trendup.ai</p>` } } },
  en: { title: "Global Trends", update: "Updated", summary: "AI Analysis Report", news: "Top Stories", videos: "YouTube News", loading: "Loading...", original: "Original", menu: { about: "About TrendUp", privacy: "Privacy Policy", terms: "Terms of Service", contact: "Contact Us", siteInfo: "Site Info" }, pages: { about: { title: "TrendUp", content: `<p>Global trend intelligence.</p>` }, privacy: { title: "Privacy", content: `<p>v2.2.3</p>` }, terms: { title: "Terms", content: `<p>Terms</p>` }, contact: { title: "Contact", content: `<p>help@trendup.ai</p>` } } }
};
...
class App {
  ...
  refreshUIText() {
    try {
      ...
      if (footerText) footerText.textContent = `© 2026 TrendUp. All rights reserved. (v2.2.3)`;
