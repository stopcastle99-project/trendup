    ...
    pages: {
      ...
      privacy: { 
        ...
        content: `
          ...
          <p style="margin-bottom:1rem;">TrendUp(이하 '서비스')은 이용자의 개인정보 보호를 최우선으로 생각하며, 관련 법령을 준수합니다. (v2.4.4)</p>
    ...
    pages: { 
      ...
      privacy: { 
        ...
        content: `
          ...
          <p style="margin-bottom:1rem;">TrendUp（以下「当サービス」）は、ユーザーのプライバシーを尊重し、個人情報の保護に努めます。(v2.4.4)</p>
          <h3>1. 情報の収集について</h3>
    ...
    pages: { 
      ...
      privacy: { 
        ...
        content: `
          ...
          <p style="margin-bottom:1rem;">TrendUp ("Service") values users' personal information and complies with relevant laws and regulations. (v2.4.4)</p>
...
class App {
  ...
  refreshUIText() {
    try {
      ...
      if (footerText) footerText.textContent = `© 2026 TrendUp. All rights reserved. (v2.4.4)`;
